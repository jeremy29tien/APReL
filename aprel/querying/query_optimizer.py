    ...
    def greedy_batch(self,
        ...
        Returns:
                2-tuple:
                    ...
                    - numpy.array: An array of floats that keep the acquisition function values corresponding to the output queries.
        """
        if isinstance(initial_query, PreferenceQuery) or isinstance(initial_query, NLCommandQuery) or isinstance(initial_query, WeakComparisonQuery) or isinstance(initial_query, FullRankingQuery):
